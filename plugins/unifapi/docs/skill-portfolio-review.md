...
| Clay/enrichment/outbound | `lead-enrichment` (91), `sales-enrich` (72), `lead-sources-guide` (57), `clay-enrichment-9step` (53), `lead-enrichment` (51), `sales-clay` (34) | Enrichment waterfalls, CRM handoff, contact data quality, and outbound readiness are real skill demand. | Keep `company-domain-enrichment` and `gtm-table-enrichment` agent-native for small batches; keep `email-contact-finder` and `crm-export-sequence` as API-backfill skills. |
...
| --- | --- | --- | --- |
| Account research and signal monitoring | Clay docs emphasize Find, Enrich, Signals, new hires, job changes, promotions, web intent, and export workflows. | `account-research-brief`, `account-signal-monitor`, `linkedin-hiring-signal-finder`, `linkedin-people-enrichment`, `buyer-committee-mapper`, `company-domain-enrichment`, `gtm-table-enrichment`, `web-intent-visitor-tracking`, `crm-export-sequence` | Strong for LinkedIn/public social and agent-native small-batch enrichment today; web intent, CRM, export, and bulk provider APIs still need backfill. |
...
| --- | --- | --- | --- | --- |
| Product intake, strategy document, competitor analysis, brand voice, growth playbook | Partial | `account-research-brief`, `competitor-gtm-monitor`, `category-demand-scout`, `cross-channel-content-brief`, `web-research-agent` | Can build an evidence-backed GTM brief from provided product context, agent-native web research, and public social/LinkedIn evidence. | Durable brand memory, saved strategy workspace, scheduled refresh, and productized crawl/news extraction. |
...
| X Agent: daily brand-voice tweet drafts and optional direct posting | Partial | `x-social-listening`, `x-list-monitor`, `x-community-monitor`, `cross-channel-content-brief`, `social-launch-monitor` | Can monitor X topics/lists/communities and draft content from live public signals. | Direct account posting, scheduling, brand voice memory, autonomous cadence. |
| LinkedIn Agent: founder-voice LinkedIn posts | Partial | `linkedin-company-content-monitor`, `linkedin-founder-lead-list`, `outbound-personalization-brief`, `cross-channel-content-brief` | Can inspect public LinkedIn company/person signals and draft founder-style posts or outreach angles. | LinkedIn account posting, scheduled publishing, private account analytics, durable brand/persona memory. |
...
| Articles Writer Agent: full SEO article production and CMS publish | Partial | `cross-channel-content-brief`, `youtube-topic-monitor`, `reddit-voice-of-customer`, `autonomous-channel-agent` | Can generate content briefs and draft article outlines from public demand signals. | SEO keyword validation, full article workflow, CMS connectors, direct publish, editorial approval queue. |
...
| UGC Agent: guided briefs and AI video clips for social/ads | No current coverage | None dedicated | Creator/social research can inform briefs, but video generation is outside this portfolio. | Video generation, asset pipeline, ad creative workflow, rights/brand safety metadata. |
...
| Partial today | `x-social-listening`, `x-list-monitor`, `x-community-monitor`, `linkedin-company-content-monitor`, `cross-channel-content-brief`, `social-launch-monitor`, `account-signal-monitor`, `competitor-gtm-monitor`, `category-demand-scout`, `outbound-personalization-brief`. |
| Agent-native today; API productization pending | `web-research-agent`, `web-page-change-monitor`, `news-pr-monitor`, `seo-aeo-monitor`, `hacker-news-opportunity-monitor`, `technical-seo-repo-auditor`. |
...
| Not covered by this portfolio | UGC/video generation and hosted autonomous PR automation as a UnifAPI product workflow. |
...
| --- | --- | --- | --- | --- |
| Find companies | Partial | `linkedin-founder-lead-list`, `market-map-from-social`, `partner-prospect-finder`, `company-domain-enrichment`, `web-research-agent` | Can discover companies from LinkedIn/social evidence and agent-native web search, then build market or partner lists with cited confidence. | Proprietary company database, bulk domain-to-company resolution, rich firmographics, filters by revenue/headcount/tech stack/funding. |
| Find people | Partial | `linkedin-founder-lead-list`, `linkedin-people-enrichment`, `buyer-committee-mapper` | Can enrich known public LinkedIn profile slugs and map likely buying committee roles from public signals. | People search database, private/contact fields, verified emails/phones, full identity resolution. |
...
| Signals: new hires, promotions, job changes, LinkedIn mentions, news/fundraising | Partial | `account-signal-monitor`, `linkedin-hiring-signal-finder`, `competitor-talent-watch`, `news-pr-monitor`, `scheduled-signal-alerts` | Can detect LinkedIn hiring and public social/company signals on demand. | Persistent signals, scheduled runs, promotion/job-change detection at contact scale, news/fundraising API, alert delivery. |
...
| Transform, clean, format, and restructure table data | Partial | `gtm-table-enrichment`, `crm-export-sequence`, `outbound-personalization-brief`, `cross-channel-content-brief` | Agents can run JS/TS/Python over CSV/JSON/Markdown tables, normalize fields, add source columns, and produce import-ready outputs. | Persistent table model, formulas, row-level runs, column operations, versioned data workflows. |
| Gen AI / Claygent / Sculptor-style research and copy | Partial | `outbound-personalization-brief`, `cross-channel-content-brief`, `account-research-brief`, `web-research-agent`, `gtm-table-enrichment` | Can generate briefs, copy, personalization, and research synthesis from cited web/social evidence and row-level inputs. | Clay table execution context, persistent per-row AI runs, integrated approval/evaluation loops. |
...
> Clay-like GTM data workflows and Okara-like channel-agent outputs, powered by UnifAPI public social/professional APIs plus agent-native search, fetch, shell, and code execution.
